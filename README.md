...
Standalone generator that renders a Kali yantra image with Pillow (PIL),
using supersampling for clean edges.

- Generate the image: double-click **Draw Yantra.command** (writes `kali_yantra.jpg`)
